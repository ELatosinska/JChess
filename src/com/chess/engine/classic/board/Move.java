...
public abstract class Move {
    ...
    public int hashCode() {
        ...
        result = result * prime + this.getDestinationCoordinate();
    ...
    public static class MajorAttackMove extends AttackMove {
        ...
        public String toString() {
            return movedPiece.getPieceType().toString() + "x" + BoardUtils.getPositionAtCoordinate(destinationCoordinate);
        }
    }
    ...
    public static class AttackMove extends Move {
        ...
        public boolean equals(final Object other) {
            ...
            return this.getAttackedPiece() == otherAttackMove.getAttackedPiece() &&
                   super.equals(otherAttackMove);
        }

        @Override
        public String toString() {
            return movedPiece.toString() + "x" + BoardUtils.getPositionAtCoordinate(destinationCoordinate);
        }
...
// podzielic klase na SlidingMove i JumpingMove
